...
- **Version**: 2.2.0 — shipping as `lib/mabda.cyr` in the Cyrius stdlib
...
- **Tests**: 273 CPU-only assertions in `tests/tcyr/mabda.tcyr` plus a
...
cyrius test tests/tcyr/mabda.tcyr        # 273 CPU assertions
...
- **Tests are the way** — 273 CPU assertions + 1 GPU integration test,
