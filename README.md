...
Version: 3.0.0 (dual backend — wgpu + native AMD; see
*Hardware support* below. GA cut 2026-06-02 after the 24-hour soak
gate cleared — `--workload=all` ran 26 h 13 m with RSS flat and
dmesg Δ = 0 on cyrius 6.0.27; see
