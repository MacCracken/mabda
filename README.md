...
Version: 3.0.1 (dual backend — wgpu + native AMD; see
...
dmesg Δ = 0; see `docs/handoff/soak-20260601T222652Z/`. 3.0.1 advances
the cyrius pin to 6.0.43 with a 6 h confirmation soak.)
